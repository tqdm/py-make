...
# -*- coding: utf-8 -*-
"""
The funny thing is we can't very well import this module to install itself.
So we reimplement Makefile parsing all over again here!
"""
...
__version__ = None
version_file = os.path.join(os.path.dirname(__file__), 'pymake', '_version.py')
